...
const parseFunctionDeclaration = (abbreviationNodes: string): FunctionDeclaration => {
  const { name, async, functionParams } = parseFunctionAbbreviation(abbreviationNodes.replace('>', ''));
